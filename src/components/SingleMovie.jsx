  ...
  return (
    <main>
      <div className="wrapper mt-10">
        <div className="mb-2 md:mb-8 flex items-center justify-end gap-2">
          <button
            onClick={() => navigate(-1)}
          ...
          <div className="movie-card movie-hero overflow-hidden flex flex-col justify-center items-center gap-y-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-x-6 gap-y-4">
              ...
              <div className="text-left">
                <div className="flex flex-col md:flex-row justify-start md:items-center gap-y-2 gap-x-4">
                ...
                <div className="movie-stats flex-wrap gap-2  max-w-md mt-4">
